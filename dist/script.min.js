const modal=document.querySelector(".modal"),span=modal.querySelector("span"),content=modal.querySelector(".modal-content"),nav=document.querySelector(".main-navigation");let clone,images,showIndex=0;function showModal(e,n,o){images=e,showIndex=o,modal.style.display="block",clone=n.cloneNode(!0),content.appendChild(clone),updateText(),nav.style.display="none"}function closeModal(){content.removeChild(clone),modal.style.display="none",nav.style.display="block"}function nextImage(){showImage(1),updateText()}function prevImage(){showImage(-1),updateText()}function showImage(e){content.removeChild(clone),setIndex(e),clone=images[showIndex].cloneNode(!0),content.appendChild(clone)}function setIndex(e){showIndex+=e,-1===showIndex&&(showIndex=images.length-1),showIndex===images.length&&(showIndex=0)}function updateText(){span.innerHTML=`${showIndex+1} / ${images.length-1}`}
/*! lazysizes - v5.2.0 */
